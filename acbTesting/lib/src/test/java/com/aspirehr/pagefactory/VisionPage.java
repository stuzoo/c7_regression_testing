...
public class VisionPage extends DetailPage {
	WebDriver driver;	
	...
	public VisionPage(WebDriver driver) {
		super(driver);
		this.driver = driver;
...
//		}
	...
	public void selectDependent(int dependentId) {
		try {	
			...
			List<WebElement> dependentList = SeleniumUtil.findElementListByIdSuffix(driver, By.className("sapMCbMark"), deptUIId, 3);
	...
	public float getSelectedPlanCost(int planNo) {
		...
		List<WebElement> elementList = SeleniumUtil.findElementListByIdSuffix(driver, By.className("sapMObjectNumberStatusNone"),
				fldSuffix, 2);
	...
	public int getDependentCount() {
		...
		try {		
			...
			List<WebElement> dependentList = SeleniumUtil.findElementListByIdRegex(driver, By.className("sapMCbMark"), regex, 8);//IdSuffix(driver, By.className("sapMCbMark"), deptUIId, 3);
					//findElementListByClassName(driver, "sapMCbMark");
			// SeleniumUtil.findElementListBySuffix();
	...
	public int getSelectedDeptCount() {
		...
		try {
			...
			List<WebElement> deptList = SeleniumUtil.findElementListByIdRegex(driver, By.tagName("input"),
					regEx, 2);
			System.out.println("Vision Deptlist Size:"+ deptList.size());
