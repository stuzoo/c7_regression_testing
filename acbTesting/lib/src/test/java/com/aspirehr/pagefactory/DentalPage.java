...
public class DentalPage extends DetailPage {
	WebDriver driver;	
...
//		}
	...
	public int getDependentCount() {
		...
		try {		
			...
			List<WebElement> dependentList = SeleniumUtil.findElementListByIdRegex(driver, By.className("sapMCbMark"), regex, 4);//IdSuffix(driver, By.className("sapMCbMark"), deptUIId, 3);
					//findElementListByClassName(driver, "sapMCbMark");
			// SeleniumUtil.findElementListBySuffix();
