...
import com.aspirehr.pagefactory.HSASavingPlanPage;
...
public class C7_004_HSA {
	...
	private static HSASavingPlanPage hsaSavingPlanPage;
...
//		options.addArguments("--window-size=1920,1200");
		...
		hsaSavingPlanPage = new HSASavingPlanPage(driver);
	...
	public void test01_HSAamounts() {
		...
		try {
			Thread.sleep(5000);
			Thread.sleep(5000);
			masterListPage.clickMasterListItem("Dependent Care Spending Plan");
			Thread.sleep(3000);
			
			hsaSavingPlanPage.enterRegularContribution("9999999"); ;// sapMListTblSelCol
			hsaSavingPlanPage.savePlan();
