...
public class C7_001_DefaultingPlans {
...
//		options.addArguments("--window-size=1920,1200");
	...
	public void test01_CreditDefaulting() {
		// Navigate to Anytime Enrollment--> Credit Plan and save
		...
		try {
			Thread.sleep(5000);
			Thread.sleep(5000);
			masterListPage.clickMasterListItem("Flex Credit");
			Thread.sleep(3000);
	...
	@Test(priority = 2, dependsOnMethods = { "test01_CreditDefaulting" })
	public void test02_CreditDefaulting() {
		// Navigate to Credit Plan and check defaulting
		...
		try {
			...
			flexCreditPage.clickUpdate();// sapMListTblSelCol
//			int selPlan = flexCreditPage.getSelectedPlan();
			Assert.assertEquals(1, flexCreditPage.getSelectedPlan());
		} catch (InterruptedException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
